      ...
      <div className={style.cadastro}>
        <div className={style.containercad}>
          ...
          <form className={style.entradas} onSubmit={handleCadastro}>
            ...
            <input className={style.input} type="number" title="Digite seu CPF sem pontuação" placeholder="CPF" value={cpfcad} onChange={(e) => {const value = e.target.value; if (value.length <= 11) { setCpfcad(value); }}} required/>
            ...
            <Link href="/login"><p className={style.link}>Já sou cliente</p></Link>
