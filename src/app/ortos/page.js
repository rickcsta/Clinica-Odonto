...
<div className={style.procedimentos} id="procedimentos">
  ...
  <div className={style.imgdescrip}>
    <div className={style.ladoesq}>
      <h3>Limpeza</h3>
      <p>A limpeza dentária é essencial para remover placa, tártaro e manchas, prevenindo cáries e doenças gengivais, garantindo uma boca saudável.</p>
      <h3>Extrações</h3>
      <p>A extração dentária é a remoção de um dente danificado ou problemático, quando não há outras opções de tratamento.</p>
      <h3>Restaurações</h3>
      <p>As restaurações dentárias são procedimentos para reparar dentes danificados por cáries, fraturas ou desgaste, devolvendo a função e estética ao dente afetado.</p>
      <h3>Clareamento Dentario</h3>
      <p>O clareamento dental é um procedimento estético que visa melhorar a cor dos dentes, removendo manchas e deixando-os mais brancos e brilhantes.</p>
    </div>
